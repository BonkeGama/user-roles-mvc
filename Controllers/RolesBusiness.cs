...
namespace Roles.BusinessLogic
{
    public class RolesBusiness
    {
        ...
        {
            RoleManager = new RoleManager<ApplicationRole>(store: new RoleStore<ApplicationRole>(context: new HospitalDbContext()));
            UserManager = new UserManager<ApplicationUser>(store: new UserStore<ApplicationUser>(context: new HospitalDbContext()));
        }
